...
# Use local glfw from _deps when available to avoid FetchContent (no outbound network)
set(LOCAL_GLFW_DIR "${MUJOCO_LOCAL_DEPS_DIR}/glfw3-src")
if(MUJOCO_USE_LOCAL_DEPS AND EXISTS "${LOCAL_GLFW_DIR}/CMakeLists.txt")
  message(STATUS "Using local GLFW from ${LOCAL_GLFW_DIR}")
  add_subdirectory(
    ${LOCAL_GLFW_DIR}
    ${CMAKE_BINARY_DIR}/_deps/glfw3-build
    EXCLUDE_FROM_ALL
  )
else()
  findorfetch(
